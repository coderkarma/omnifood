...
<head>
    ...
    <meta name="description" content="Omnifood is premium food delivery service with the mission to bring affortable and healthy meals to as many people as possible.">
    ...
    <link rel="stylesheet" type="test/css" href="resources/css/queries.css">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-119906799-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'UA-119906799-1');
    </script>
...
<body>
    <header>
        <nav>
            <div class="row">
                <img src="resources/img/logo-white.png" alt="Omnifood log" class="logo">
                <img src="resources/img/logo.png" alt="Omnifood log" class="logo-black">
    ...
    <section class="section-features js--section-features" id="features">
        <div class="row">
            <h2> Get food fast &dash; not fast food</h2>
            <p class="long-copy">
    ...
    <section class="section-steps">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box" id="works">
    ...
    <section class="section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            ...
            <div class="col span-1-of-4 box">
                <img src="resources/img/san-francisco.jpg" alt="San Franciso">
                <h3>San Franciso</h3>
                <div class="city-feature">
                    <i class="ion-ios-person icon-small"></i>
                    3700+ happy eaters
...
<footer>
    <div class="row">
        ...
        <div class="row">
            <p>Copyright &copy; 2015 by Omnifood. All rightsreserved </p>
        </div>
    </footer>
